...
<html>
    ...
    <meta charset="utf-8">
        ...
        <title>Upload New Services</title>
        ...
        <div class="container">
            <nav class="navbar">
                ...
                <div class="navbar-left">
                    <a class="active-link" href="UploadNewServices.php">Upload<span class="sr-only">(current)</span></a>
                    <a class="nav-link" href="ViewUploadedImages.php">View</a>
                </div>
            ...
            <main>
                <div class="upload">
                <h3> Please Upload New Service Images to database.</h3>
